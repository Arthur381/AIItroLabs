...
class MontoCarloLocalization:#蒙泰卡洛定位
    ...
    def generate_uniform_particles(self):#均匀采样，初始化生成例子
    ...
    #@profile
    def __calc_particle_weights(self, iter: int):#计算权重，并归一化
    ...
    def __resample_particles(self):#进行重采样
